...
This activity will be introduced in our 29 Feb.\ tutorial, where there should be plenty of time to analyze the $N_1 = N_2 = 10$ case.
You can keep working on the larger-$N$ cases afterwards; we'll review them during our next tutorial on 7 March.
...
\end{equation*}
For a micro-canonical ensemble in thermodynamic equilibrium, the entropy is $S = \log M$, giving
\begin{equation*}
