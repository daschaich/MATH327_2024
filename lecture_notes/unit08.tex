...
\renewcommand{\moddate}{Last modified 31 Mar.~2024}
...
The plot below (produced by \href{https://github.com/daschaich/MATH327_2024/blob/main/lecture_notes/unit08_pressure.py}{this Python code}) shows how the pressure changes from a positive constant as $T \to 0$ to this linear behaviour at higher temperatures. \\[-24 pt]
...
Fortunately, it is not hard to numerically evaluate this integral, which is done by \href{https://github.com/daschaich/MATH327_2024/blob/main/lecture_notes/unit08_fermi-gas.py}{this Python code}.
