...
\renewcommand{\moddate}{Last modified 12 Mar.~2024}
...
In this unit we will consider only indistinguishable particles, so that we don't need to keep track of which particular particles are exchanged between the replicas, only the overall number. % TODO: Note that this is required in order for the chemical potential to make sense...
